...
本目录包含 10 份逐 case 审核报告：4 条 setup、4 条 hold、2 条 mixed。每份报告均嵌入完整 instruction、规范 Probe/注入入口 Tcl、冻结注入动作展开、完整 Gold fix Tcl、设计初始状态、命令说明以及 Innovus/PrimeTime 实测结果。
...
|---|---|---:|---:|---:|---:|---:|---|
| `SETUP_001` | setup / easy | -0.042 ns | +0.050 ns | +0.015 ns | +0.050 ns | 2 | [SETUP_001](SETUP_001.md) |
| `SETUP_002` | setup / medium | -0.098 ns | +0.050 ns | +0.027 ns | +0.050 ns | 4 | [SETUP_002](SETUP_002.md) |
| `SETUP_003` | setup / hard | -0.203 ns | +0.050 ns | +0.051 ns | +0.050 ns | 6 | [SETUP_003](SETUP_003.md) |
| `SETUP_004` | setup / medium | -0.096 ns | +0.050 ns | +0.051 ns | +0.050 ns | 8 | [SETUP_004](SETUP_004.md) |
| `HOLD_001` | hold / easy | +0.051 ns | -0.032 ns | +0.051 ns | +0.050 ns | 1 | [HOLD_001](HOLD_001.md) |
| `HOLD_002` | hold / medium | +0.051 ns | -0.065 ns | +0.051 ns | +0.050 ns | 2 | [HOLD_002](HOLD_002.md) |
| `HOLD_003` | hold / hard | +0.051 ns | -0.119 ns | +0.051 ns | +0.050 ns | 2 | [HOLD_003](HOLD_003.md) |
| `HOLD_004` | hold / medium | +0.052 ns | -0.072 ns | +0.052 ns | +0.050 ns | 2 | [HOLD_004](HOLD_004.md) |
| `MIXED_001` | mixed / medium | -0.144 ns | -0.069 ns | +0.022 ns | +0.050 ns | 5 | [MIXED_001](MIXED_001.md) |
| `MIXED_002` | mixed / hard | -0.385 ns | -0.103 ns | +0.051 ns | +0.050 ns | 11 | [MIXED_002](MIXED_002.md) |
